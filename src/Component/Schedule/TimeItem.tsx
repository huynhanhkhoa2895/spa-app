...
const TimeItem = (props: any) => {
    ...
    const renderItem = () => {
        ...
        const time = moment(`${props.daySelected} ${props.hour}:${props.minute}`, "YYYY-MM-DD H:mm")
...
const style = StyleSheet.create({
    ...
    active: { borderColor: "#f070a0", backgroundColor: "#f070a0" },
    inactive: { borderColor: "#ccc", backgroundColor: "#ccc" },
    activeTime: { borderColor: "#f070a0", backgroundColor: "#fff" },
